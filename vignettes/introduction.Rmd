...
```{r, eval = FALSE}
# install.packages("devtools") # Only if you do not have the devtools package already
...
The function `journey()` returns a route from A to B.

```{r, eval =TRUE}
from = c(-0.134649,51.529258) # Euston Station
to = c(-0.088780,51.506383) # Bridge House
r1 = transportAPI::journey(from, to)
plot(r1["mode"])
```
